...
/**
 * Data source meta data for kingbase8
 */
@Getter
public final class KingBase8DataSourceMetaData implements DataSourceMetaData {
    ...
    public KingBase8DataSourceMetaData(final String url, final String username) {
